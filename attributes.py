...
attribute = Attribute(name='hb', unit='g/L', min_male=2.09, max_male=2.71, min_female=1.86, max_female=2.48,
...
attribute = Attribute(name='hct', unit='%', min_male=41, max_male=53, min_female=36, max_female=46,
...
db.session.add(attribute)
attribute = Attribute(name='rbc', unit='cells/L', min_male=4.3, max_male=5.9, min_female=3.5, max_female=5.5,
...
db.session.add(attribute)
attribute = Attribute(name='mcv', unit='fL', min_male=80, max_male=100, min_female=80, max_female=100,
...
db.session.add(attribute)
attribute = Attribute(name='mch', unit='pg', min_male=0.39, max_male=0.54, min_female=0.39, max_female=0.54,
...
db.session.add(attribute)
attribute = Attribute(name='wbc', unit='cells/L', min_male=4.5, max_male=11.0, min_female=4.5, max_female=11.0,
...
db.session.add(attribute)
attribute = Attribute(name='plt', unit='cells/L', min_male=150, max_male=400, min_female=150, max_female=400,
